...
const T = {
  de: {
    ...
    'hero.brandsCaption': 'Unsere Marken',
    ...
    'faq.q1': 'Wer bietet KUKA-, FANUC- und Yaskawa-Roboterprogrammierung an?',
    'faq.a1': 'RoboPower Solutions, geführt von Jan Bremauer, ist ein inhabergeführter Robotik-Dienstleister mit 10+ Jahren Projekterfahrung. Wir programmieren und nehmen Roboter aller drei Hersteller in Betrieb — bundesweit und international.',
    'faq.q2': 'Welche Leistungen bietet RoboPower Solutions konkret an?',
    'faq.a2': 'Roboterprogrammierung (KUKA/FANUC/Yaskawa), Safety-Abnahmen, INTEGRA-W7-Standardisierung für Mercedes-Benz AG, Inbetriebnahme & Projektleitung sowie CNC-Automation und Maschinenbeladung in Thailand/SEA.',
    'faq.q3': 'Was gehört zu einer Safety-Abnahme für Industrieroboter?',
    'faq.a3': 'Sicherheitskonfiguration, Zonen-Setup und Freigabe nach Maschinenrichtlinie — herstellerübergreifend mit SafeOperation 3.4, DCS und FSU.',
    'faq.q4': 'Bietet RoboPower Solutions auch CNC-Automation in Thailand/SEA an?',
    'faq.a4': 'Ja. Mit über 10 Jahren Markterfahrung in Thailand (u. a. als Service- und Anwendungstechniker für 5-Achs-CNC-Maschinen 2015–2017) übernehmen wir die vollautomatische Beladung und Automation von CNC-Maschinen — von der Vor-Ort-Analyse bis zum Serienstart.',
    'faq.q5': 'In welchen Regionen ist RoboPower Solutions tätig?',
    'faq.a5': 'Standort ist Göppingen (Baden-Württemberg). Projekte wurden u. a. in Deutschland, Mexiko, den USA, Tschechien und Thailand realisiert — Einsatz ist bundesweit und international möglich, vor Ort und remote.',
    'faq.q6': 'Was ist der INTEGRA-W7-Standard?',
    'faq.a6': 'INTEGRA W7 ist die Mercedes-Benz AG Richtlinie zur Standardisierung von KUKA-KRC5-Robotersystemen im OEM-Umfeld. RoboPower Solutions ist seit 2023 nach diesem Standard zertifiziert.',
    'faq.q7': 'Wie schnell antwortet RoboPower Solutions auf Anfragen?',
    'faq.a7': 'Antworten erfolgen in der Regel innerhalb von 24 Stunden.',
  ...
  en: {
    ...
    'faq.q1': 'Who provides KUKA, FANUC and Yaskawa robot programming?',
    'faq.a1': 'RoboPower Solutions, run by Jan Bremauer, is an owner-managed robotics service provider with 10+ years of project experience. We program and commission robots from all three brands — nationwide and internationally.',
    'faq.q2': 'What services does RoboPower Solutions offer specifically?',
    'faq.a2': 'Robot programming (KUKA/FANUC/Yaskawa), safety sign-offs, INTEGRA W7 standardization for Mercedes-Benz AG, commissioning & project management, and CNC automation / machine loading in Thailand/SEA.',
    'faq.q3': "What's included in a robot safety sign-off?",
    'faq.a3': 'Safety configuration, zone setup and sign-off to Machinery Directive standards — across all robot brands, using SafeOperation 3.4, DCS and FSU.',
    'faq.q4': 'Does RoboPower Solutions also handle CNC automation in Thailand/SEA?',
    'faq.a4': 'Yes. With 10+ years of market experience in Thailand (including as a service and application technician for 5-axis CNC machines from 2015–2017), we handle fully automated loading and automation of CNC machines — from on-site analysis to series start.',
    'faq.q5': 'Which regions does RoboPower Solutions work in?',
    'faq.a5': 'Based in Göppingen (Baden-Württemberg). Projects have been realized in Germany, Mexico, the USA, the Czech Republic and Thailand — available nationwide and internationally, on-site and remote.',
    'faq.q6': 'What is the INTEGRA W7 standard?',
    'faq.a6': 'INTEGRA W7 is the Mercedes-Benz AG guideline for standardizing KUKA KRC5 robot systems in OEM environments. RoboPower Solutions has been certified to this standard since 2023.',
    'faq.q7': 'How quickly does RoboPower Solutions respond to inquiries?',
    'faq.a7': 'Responses are typically sent within 24 hours.',
